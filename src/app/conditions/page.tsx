    ...
    <div className="min-h-screen bg-background py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">2. Acceptation des CGU</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">3. Services proposés</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">4. Inscription et compte utilisateur</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">5. Publication d&apos;annonces</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">6. Obligations de Tomobile 360</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">8. Limitation de responsabilité</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">9. Sanctions</h2>
            <p className="text-gray-600">
