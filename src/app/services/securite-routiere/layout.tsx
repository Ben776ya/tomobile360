...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.tomobile360.ma/services/securite-routiere',
  },
  openGraph: {
    ...
    url: 'https://www.tomobile360.ma/services/securite-routiere',
    type: 'website',
    images: [
      {
        url: 'https://www.tomobile360.ma/narsa_logo.png',
