export default function LoadingOccasion() {
  return (
    <div className="min-h-screen bg-muted/30">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <div className="h-10 w-56 bg-primary/20 rounded-lg animate-pulse mb-2" />
            <div className="h-5 w-80 bg-muted rounded-lg animate-pulse" />
          </div>
          <div className="h-12 w-44 bg-primary/30 rounded-lg animate-pulse" />
        </div>
              ...
              {[...Array(12)].map((_, i) => (
                <div key={i} className="bg-white rounded-xl border border-border overflow-hidden shadow-card">
                  ...
                  <div className="aspect-[4/3] bg-muted animate-pulse relative">
                    {/* Badge placeholders */}
                    <div className="absolute top-3 left-3 h-6 w-20 bg-white/50 rounded animate-pulse" />
                    <div className="absolute top-3 right-3 h-8 w-8 bg-white/50 rounded-full animate-pulse" />
                  </div>
                  {/* Content skeleton */}
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="h-7 w-28 bg-secondary/30 rounded animate-pulse" />
