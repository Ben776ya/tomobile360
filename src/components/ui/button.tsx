...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:hover:transform-none disabled:hover:shadow-none",
  {
    variants: {
      variant: {
        default: "bg-[#006EFE] text-white hover:bg-[#0058cb] hover:shadow-glow-indigo-sm hover:-translate-y-0.5",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-lg hover:-translate-y-0.5",
        outline: "border border-[#006EFE] text-[#006EFE] hover:bg-[#006EFE] hover:text-white hover:shadow-glow-indigo-sm hover:-translate-y-0.5",
        secondary: "bg-[#006EFE] text-white hover:bg-[#0058cb] hover:shadow-glow-cyan-sm hover:-translate-y-0.5",
        ghost: "hover:bg-white/5 hover:text-secondary",
